var size = 0;
var placement = 'point';
function categories_infrastructure_de_sante_3(feature, value, size, resolution, labelText,
                       labelFont, labelFill, bufferColor, bufferWidth,
                       placement) {
                switch(value.toString()) {case 'CH_DEP':
...
case 'DISPENSAIRE':
        ...
        image: new ol.style.Circle({radius: 2.64616 + size,
            stroke: new ol.style.Stroke({color: 'rgba(227,26,28,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0}), fill: new ol.style.Fill({color: 'rgba(227,26,28,1.0)'})}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
...
var style_infrastructure_de_sante_3 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
...
var style = categories_infrastructure_de_sante_3(feature, value, size, resolution, labelText,
